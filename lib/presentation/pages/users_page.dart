...
class _UsersPageState extends State<UsersPage> {
  ...
  void initState() {
    ...
    _watchSubscription =
        widget.userRepository.watchUsers().listen(
              (_) {
            _loadUsers();
          },
        );
  ...
  Future<void> _loadUsers() async {
    try {
      final users =
      await widget.userRepository.getUsers();
  ...
  Future<void> _deleteUser(User user) async {
    ...
    try {
      ...
      await widget.postRepository
          .deletePostsByUser(user.id);

      _showMessage(
        'User and its posts deleted',
      );
    } catch (e) {
      _showMessage(
  ...
  Future<void> _deleteAllUsers() async {
    ...
    try {
      ...
      _showMessage(
        'All users and posts deleted',
      );
    } catch (e) {
      _showMessage(
        'Failed to delete all data: $e',
      );
    }
  }
